...
public class GameManager3D : MonoBehaviour
{
    ...
    void PlacePiece()
    {
        ...
        Debug.DrawLine(mousePosition, mousePosition + Vector3.up * 10, Color.red);
        RaycastHit hit;
    ...
    IEnumerator AITurn()
    {
        ...
        // 放置AI的棋子
        GameObject newP = Instantiate(whitePiecePrefab, new Vector3(x,0, y), Quaternion.Euler(-90,0,0));
        newP.transform.SetParent(transform);
        luoZi.Play();
